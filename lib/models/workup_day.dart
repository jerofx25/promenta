...
WorkupType _workupTypeFromJson(String? type) {
  if (type == null) return WorkupType.bodybuilding;
  switch (type.toLowerCase()) {
    case 'endurance': return WorkupType.endurance;
    case 'powerlifting': return WorkupType.powerlifting;
    case 'crossfit': return WorkupType.crossfit;
    case 'weightlifting': return WorkupType.weightlifting;
    case 'bodybuilding': return WorkupType.bodybuilding;
    default: return WorkupType.bodybuilding;
  }
}

DifficultyLevel _difficultyFromJson(String? difficulty) {
  if (difficulty == null) return DifficultyLevel.basic;
  switch (difficulty.toLowerCase()) {
    case 'basic': return DifficultyLevel.basic;
    case 'intermediate': return DifficultyLevel.intermediate;
    case 'elite': return DifficultyLevel.elite;
    default: return DifficultyLevel.basic;
  }
}
...
class WorkupDay {
  ...
  factory WorkupDay.fromJson(Map<String, dynamic> json) => WorkupDay(
        ...
        type: _workupTypeFromJson(json["type"] as String?),
