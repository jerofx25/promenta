...
class _WeightSelectionScreenState extends State<WeightSelectionScreen>
  ...
  void _initializeWeightValues() {
    ...
    final initialIndex = ((_selectedWeight - _minWeight) * 2).round();
  ...
  void _selectWeight(double weight) {
    final index = ((weight - _minWeight) * 2).round();
  ...
  void _handleContinue() async {
    ...
    final profile =
        context.read<OnboardingCubit>().state.profile;
    final heightInM = ((profile?.height ?? 170) / 100);
                        ...
                        RotatedBox(
                          ...
                          child: ListWheelScrollView.useDelegate(
                            ...
                            onSelectedItemChanged: (index) {
                              setState(() {
                                _selectedWeight = double.parse((_minWeight + (index / 2)).toStringAsFixed(1));
                              });
                            },
                                          ...
                                          if (isWhole)
                                            Text(
                                              ...
                                              style: theme.textTheme.bodyMedium?.copyWith(
                                                color: weight == _selectedWeight.roundToDouble()
                                                    ? theme.colorScheme.primary
                                                    : Colors.white.withOpacity(0.5),
                                                fontWeight: weight == _selectedWeight.roundToDouble()
                                                    ? FontWeight.bold
                                                    : FontWeight.normal,
                                              ),
                                            ),
