...
class _RMCalculatorScreenState extends State<RMCalculatorScreen>
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              try {
                ...
                context.read<ExerciseCubit>().addExercise(name, weight);
  ...
  Widget _buildExerciseSelector(ExerciseState state) {
    final theme = Theme.of(context);
          ...
          CustomDropdown<String>(
            ...
            onChanged: (String? value) {
              if (value != null) {
                ...
                context.read<ExerciseCubit>().selectExercise(exercise.id);
