                    ...
                    builder: (context, child) {
                      return CustomPaint(
                        painter: ActivityRingsPainter(
                          moveProgress: _currentCalories /
                              _targetCalories *
                              _progressAnimation.value,
                          exerciseProgress: _activeMinutes /
                              _targetActiveMinutes *
                              _progressAnimation.value,
                          standProgress: _currentSteps /
                              _targetSteps *
                              _progressAnimation.value,
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildActivityStat(
                        ...
                        progress: _currentCalories / _targetCalories,
                        unit: 'CAL',
                        theme: theme,
                      ),
                      const SizedBox(height: 16),
                      _buildActivityStat(
                        icon: Icons.timer,
                        label: 'EJERCICIO',
                        value: '$_activeMinutes/$_targetActiveMinutes',
                        color: AppTheme.exerciseRingColor,
                        progress: _activeMinutes / _targetActiveMinutes,
                        unit: 'MIN',
                        theme: theme,
                      ),
                      const SizedBox(height: 16),
                      _buildActivityStat(
                        ...
                        label: 'PASOS',
                        value: _currentSteps.toString().replaceAllMapped(
                              RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'),
                              (Match m) => '${m[1]},',
                            ),
                        color: AppTheme.standRingColor,
                        progress: _currentSteps / _targetSteps,
                        unit:
