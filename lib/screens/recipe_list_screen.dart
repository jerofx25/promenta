          ...
          IconButton(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Funcionalidad de favoritos no implementada'),
                ),
              );
            },
          ),
            ...
            onTap: (index) {
              ...
              switch (index) {
                case 0:
                  ...
                  break;
                case 1:
                  provider.setMealTypeFilter(MealType.breakfast);
                  break;
                case 2:
                  provider.setMealTypeFilter(MealType.lunch);
                  break;
                case 3:
                  provider.setMealTypeFilter(MealType.snack);
                  break;
                case 4:
                  provider.setMealTypeFilter(MealType.dinner);
                  break;
              }
            },
          ),
